        ...
        return (
            <>
                ...
                <form className="form edit_form edit_form_primaryinfo">
                    ...
                    ></input>
                    {
                        bBUserObject.isBand
                            ...
                            <>
                                ...
                                <select
                                    required
                                    name="editPrimaryInstrument"
                                    className="input input_select input_reg input_field_colors"
                                    value={`primaryinstrument--${profile.primaryInstrumentId}`} // Set the value prop to the currently selected option
                                    onChange={e => {
                                ...
                                >
                                    {primaryInstruments.map(instrument => (
                                        <option
                                            key={`primaryinstrumentkey--${instrument.id}`}
                    ...
                    <select
                        required
                        name="editPrimaryGenre"
                        className="input input_select input_reg input_field_colors"
                        value={`primarygenre--${profile.primaryGenreId}`} // Set the value prop to the currently selected option
                        onChange={e => {
                    ...
                    >
                        {primaryGenres.map(genre => (
                            <option
                                key={`primarygenrekey--${genre.id}`}
                                value={`primarygenre--${genre.id}`}
                                className="input_field_colors"
                            >
                                {genre.name}
                            </option>
